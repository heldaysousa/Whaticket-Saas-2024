...
backend_redis_create() {
  ...
  sudo su - root <<EOF
  usermod -aG docker deployinnflow
...
sudo su - deployinnflow << EOF
  cat <<[-]EOF > /home/deployinnflow/whaticket/backend/.env
NODE_ENV=
...
backend_node_dependencies() {
  ...
  sudo su - deployinnflow <<EOF
  cd /home/deployinnflow/whaticket/backend
  npm install --force
EOF
